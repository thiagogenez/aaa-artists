...
export const metadata: Metadata = {
  title: "Connect — AAA Events",
  description: "Follow AAA Events on Instagram, SoundCloud, Facebook and YouTube for the latest news, lineups, and music.",
};
...
const socials = [
  {
    label: "Instagram",
    handle: "@aaaeventsofficial",
    href: "https://www.instagram.com/aaaeventsofficial/",
    desc: "Event announcements, lineup reveals, behind-the-scenes moments and stories from every party.",
    Icon: InstagramIcon,
  ...
  },
  {
    ...
    desc: "Full sets and playlists from every Fusion event. Relive the night or discover what you missed.",
    Icon: SoundCloudIcon,
  ...
  },
  {
    label: "Facebook",
    handle: "aaaeventsofficial",
    href: "https://www.facebook.com/aaaeventsofficial",
    desc: "Event pages, ticket links, and community updates. RSVP and share with your crew.",
    Icon: FacebookIcon,
  ...
  },
  {
    ...
    desc: "Video content from our events — live recordings, aftermovies, and artist interviews.",
    Icon: YouTubeIcon,
      ...
      <section className="border-b px-6 py-24" style={{ borderColor: "var(--border)", backgroundColor: "var(--bg-subtle)" }}>
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight md:text-6xl" style={{ color: "var(--text)" }}>
            Find us on<br />every platform.
          </h1>
          <p className="max-w-2xl text-lg leading-relaxed" style={{ color: "var(--text-60)" }}>
            Follow along for event announcements, artist mixes, ticket drops, and behind-the-scenes content from every Fusion event.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-px sm:grid-cols-2" style={{ backgroundColor: "var(--border)" }}>
            {socials.map(({ label, handle, href, desc, Icon, cta }) => (
              <a
                key={label}
                href={href}
                target="_blank"
                rel="noopener noreferrer"
                className="group relative flex flex-col gap-6 p-10 transition-all duration-300"
              ...
              >
                ...
                <div className="relative flex-1">
                  ...
                  <h2
                    className="mb-3 text-2xl font-bold transition-all duration-300 group-hover:-translate-y-0.5"
                ...
                <div className="relative flex items-center gap-2 text-sm" style={{ color: "var(--text-30)" }}>
                  <span>{cta}</span>
